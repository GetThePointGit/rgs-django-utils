        ...
        return {
            ...
            "data": [
                ...
                (
                    ...
                    "e-mail, wachtwoord en wachtwoordcode via mail",
                    2,
                    False,
                    True,
                    "2-factor via mail; vervangen door toekomstige app-gebaseerde 2FA — niet aanbieden",
                ),
                (
                    cls.PASSWORDLESS,
                    "wachtwoordloos (magic link/ otp)",
                    3,
                    True,
                    False,
                    "1-factor, live (magic-link + code in de mail)",
                ),
                (
